...
read_universe( void)
{
   ...
   universe_sym = lookup_minimal_symbol(current_program_space, "mulle_objc_defaultuniverse");
   if( ! universe_sym.minsym)
    universe_sym = lookup_minimal_symbol(current_program_space, "_mulle_objc_defaultuniverse");
...
#define n_tao_runtime_offsets (sizeof( tao_runtime_offsets) / sizeof( tao_runtime_offsets[ 0]))
   ...
   // fall back to last entry for unknown future versions
   p = (tao ? tao_runtime_offsets : runtime_offsets) + (n - 1);
   switch( bits)
   {
   case 64 : return( &p->b64);
   case 32 : return( &p->b32);
...
// TODO: mulle_objc_object_call is found like this only I don't know why
  ...
  { "mulle_objc_object_call_variable", resolve_msgsend, 0, 0},
  { "mulle_objc_object_call_inline_varable", resolve_msgsend, 0, 0},
  { "mulle_objc_object_call_inline_full_variable", resolve_msgsend, 0, 0},

  // typo fix
  { "mulle_objc_object_call_variable_inline", resolve_msgsend, 0, 0},

  { "mulle_objc_object_call_super", resolve_msgsend_super, 0, 0},
  { "mulle_objc_object_call_super_inline", resolve_msgsend_super, 0, 0},
  { "mulle_objc_object_call_super_inline_full", resolve_msgsend_super, 0, 0},
  { "mulle_objc_object_call_super_inline_partial", resolve_msgsend_super, 0, 0},


  // +_mulle_objc_impcache_callback_normal
  { "_mulle_objc_object_callback_class", resolve_msgsend, 0, 0},
  ...
  { "_mulle_objc_object_call_class_slow", resolve_msgsend, 0, 0},
  { "_mulle_objc_object_call2_slow", resolve_msgsend, 0, 0},
  { "_mulle_objc_object_call_super_slow", resolve_msgsend_super, 0, 0},

  // _mulle_objc_impcache_callback_initial
  { "_mulle_objc_object_call_class_needcache", resolve_msgsend, 0, 0},
  { "_mulle_objc_object_call2_needcache", resolve_msgsend, 0, 0},
  { "_mulle_objc_object_call_super_needcache", resolve_msgsend_super, 0, 0},
